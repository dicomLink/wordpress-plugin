	...
	private function settings_fields()
	{
		...
		$settings['general'] = array(
			...
			'fields'      => array(
				...
				array(
					'id'          => 'vault_user_id',
					'label'       => __('Secure PACS user public key id', 'dicomlinkdicomviewer'),
					'description' => __('This is your public key id to access resources on SecurePACS.<br>Used for encrypting data. Use with caution, data may be loss if improper usage.', 'dicomlinkdicomviewer'),
					'type'        => 'textarea_small',
					'default'     => '',
			...
			$settings['debug'] = array(
				...
				'fields'      => array(
					...
					array(
						...
						'label'       => __('Debug Secure PACS user public key id', 'dicomlinkdicomviewer'),
						'description' => __('This is your public key id to access resources on SecurePACS.<br>Used for encrypting data. Use with caution, data may be loss if improper usage.', 'dicomlinkdicomviewer'),
						'type'        => 'textarea_small',
						'default'     => '',
						'placeholder' => __('UUID', 'dicomlinkdicomviewer'),
					...
					array(
						'id'          => 'debug_sdk',
						'label'       => __('Debug Vault SDK Url', 'dicomlinkdicomviewer'),
						'description' => __('Debug Vault SDK Url (uploader)', 'dicomlinkdicomviewer'),
						'type'        => 'textarea_small',
						'default'     => '',
						'placeholder' => __('URL', 'dicomlinkdicomviewer'),
					),
					array(
						'id'          => 'debug_dicomviewer_sdk',
						'label'       => __('Debug DicomViewer SDK Url', 'dicomlinkdicomviewer'),
						'description' => __('Debug DicomViewer SDK Url (uploader)', 'dicomlinkdicomviewer'),
						'type'        => 'textarea_small',
						'default'     => '',
						'placeholder' => __('URL', 'dicomlinkdicomviewer'),
					),
